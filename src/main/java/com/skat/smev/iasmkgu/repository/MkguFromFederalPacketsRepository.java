...
import com.skat.smev.iasmkgu.domain.db.views.MkguFromFederalPacketsView;
...
public interface MkguFromFederalPacketsRepository extends JpaRepository<MkguFromFederalPacketsView, Long> {
    ...
    @Query(value =
            " SELECT new com.skat.smev.iasmkgu.domain.db.views.MkguIds(view.id_key, view.id_otdel, COUNT(id_key), view.id_mkgu) FROM MkguFromFederalPacketsView view " +
    ...
    @Query(value =
            " SELECT DISTINCT new com.skat.smev.iasmkgu.domain.db.views.MkguFormInfo(view.id_key, view.okato, view.id_service, view.name_service, view.id_authority, view.name_authority, view.date_event, view.user_id) FROM MkguFromFederalPacketsView view " +
    ...
    @Query(value =
            " SELECT new com.skat.smev.iasmkgu.domain.db.views.BaseMkguPacketsView(view.id_key, view.id_otdel, view.id_mkgu, view.okato, view.indicator_id, view.id_service, view.name_service, view.id_authority, view.name_authority, view.value_id, view.date_event, view.user_id) FROM MkguFromFederalPacketsView view " +
